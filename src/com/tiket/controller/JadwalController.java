...
public class JadwalController {
    ...
    public JadwalController() throws DatabaseException, SQLException {
    ...
    public void updateJadwal(Jadwal jadwal)
            throws DatabaseException, JadwalNotFoundException {
        ...
        if (existing == null) {
            throw new JadwalNotFoundException(
                    "Jadwal dengan ID " + jadwal.getIdJadwal() + " tidak ditemukan"
            );
        }
    ...
    public void hapusJadwal(String idJadwal)
        ...
        if (existing == null) {
            throw new JadwalNotFoundException(
                    "Jadwal dengan ID " + idJadwal + " tidak ditemukan"
            );
        }

        // Hapus semua kursi jadwal
    ...
    private void hapusKursiJadwal(String idJadwal) throws DatabaseException {
        ...
        for (Kursi kursi : kursiList) {
            kursiDAO.hapusKursi(kursi.getIdKursi()); // ✅ FIX UTAMA
        }
    }
    ...
    public List<Jadwal> cariJadwal(String lokasiAsal, String lokasiTujuan)
